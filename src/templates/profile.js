...
const Profile = ({ pageContext: { g } }) => {
  ...
  const fetchGovernanceTokens = async (address) => {
    setIsLoading(true);
    setTokens(null);
    const tokens = { owned: [], locked: [] }
  ...
  return (
    <>
      <Metadata
        titleTwitter="YoctoDao: A DAO pushing the limits on Cardano"
        title="YoctoDao | Profile"
        description="Govern with tokens and reputation on-chain."
      />
      <div
        style={{
          minHeight: "100vh",
          ...
          >
            ...
            >
              ...
              >
                ...
                <div style={{ fontWeight: "bold", fontSize: 18 }}>
                  {!isLoading ? tokens.locked.length : "..."}
                </div>
              </div>
              <div
                style={{
